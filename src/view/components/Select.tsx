  ...
  return (
    <div>
      <div className="relative">
        ...
        <RadixSelect.Trigger
          className={cn(
            "bg-white rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 w-full",
        ...
        <RadixSelect.Portal>
          <RadixSelect.Content className="z-[99] overflow-hidden bg-white rounded-2xl border
          border-gray-100 shadow-[0px_11px_20px_0px_rgba(0,0,0,0.10)]">
            ...
            <RadixSelect.Viewport className="p-2">
              ...
              {options.map((option) => (
                ...
                key={option.value}
                value={option.value}
                className="p-2 text-gray-800 text-small data-[state=checked]:font-bold outline-none data-[highlighted]:bg-gray-50 rounded-lg transition-colors"
              >
